...
bool dynamic_obstacle_detector_interfaces__msg__tracked_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamic_obstacle_detector_interfaces.msg._tracked_object.TrackedObject", full_classname_dest, 70) == 0);
  }
  dynamic_obstacle_detector_interfaces__msg__TrackedObject * ros_message = _ros_message;
  {  // id
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dynamic_obstacle_detector_interfaces__msg__tracked_object__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of TrackedObject */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamic_obstacle_detector_interfaces.msg._tracked_object");
  ...
  dynamic_obstacle_detector_interfaces__msg__TrackedObject * ros_message = (dynamic_obstacle_detector_interfaces__msg__TrackedObject *)raw_ros_message;
  {  // id
    PyObject * field = NULL;

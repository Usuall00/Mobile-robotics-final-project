...
def generate_launch_description():
    ...
    # Launch the global obstacle fusion node
    # This node subscribes to all individual /tracked_obstacles topics and
    # publishes a unified /global_tracked_obstacles topic and a costmap for Nav2.
    fusion_node = Node(

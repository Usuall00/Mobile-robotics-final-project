...
def generate_launch_description():
    ...
    default_world_path = os.path.join(pkg_turtlebot3_gazebo, 'worlds', 'turtlebot3_world.world')
    ...
    for robot in robots:
        ...
        bridge_template = os.path.join(pkg_slam_multi_robot, 'config', 'gz_bridge.yaml')
